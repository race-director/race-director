...
const Navigation: React.FC<NavigationProps> = ({ children }) => {
  return (
    <div className="w-full flex flex-col items-center sticky top-0 z-20">
      <div className="dark:bg-zinc-900 bg-white max-w-screen-xl w-full flex justify-between items-center dark:border-b-zinc-100/40 border-b-zinc-600/40 border border-0.5 border-t-0 border-x-0 py-4 px-4">
        <div>
          <Link href="/">
