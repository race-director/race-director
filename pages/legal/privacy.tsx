    ...
    <div className="w-full flex flex-col items-center dark:bg-zinc-900 min-h-screen pb-12">
      ...
      <div className="px-4 prose prose-sm md:prose-base prose-zinc max-w-3xl w-screen dark:prose-invert font-sans md:prose-h1:text-5xl prose-h1:text-4xl prose-h2:text-2xl md:prose-h2:text-3xl py-8 md:py-12">
        <div>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Race Director.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Race Director, accessible
                from{" "}
                <a
                  href="https://racedirector.vercel.app"
                  rel="external nofollow noopener noreferrer"
                  target="_blank"
                >
                  https://racedirector.vercel.app
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: adpadillar25@gmail.com</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{" "}
                <a
                  href="https://racedirector.vercel.app/legal/privacy"
                  rel="external nofollow noopener noreferrer"
                  target="_blank"
                >
                  https://racedirector.vercel.app/legal/privacy
                </a>
              </p>
            </li>
          </ul>
